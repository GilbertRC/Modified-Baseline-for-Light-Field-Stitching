...
#    Setting01_LFdir='Lytro'
    ...
    if(Setting01_LFdir=='synthetic'):    
        ...
        #image_w=512
        #image_h=512  
        dir_LFimages=['eslf/result_0430_0490(7)_9x9']
        image_w=619
        image_h=376
    ...
    if(len(Setting02_AngualrViews)==9):
        ...
        #path_weight='epinet_checkpoints/iter16320_mse1.496_bp3.55.hdf5'
    ...
    for image_path in dir_LFimages:
        ...
        plt.xticks([])
        plt.yticks([])
        #plt.savefig(dir_output+'/%d.png' % (i))
        i = i+1
        imageio.imwrite(dir_output+'/%d.png' % (i), val_output_tmp[0,:,:,0] )
